...
**Use the [Query Optimizer](/docs/django/guide/optimizer)** (recommended for most cases):
...
See [DataLoaders guide](/docs/django/guide/dataloaders) for details.
...
See [Nested Mutations guide](/docs/django/guide/nested-mutations) for more details.
...
See [Error Handling guide](/docs/django/guide/error-handling) for details.
...
See [Permissions guide](/docs/django/guide/permissions) for more options.
...
See [Guardian integration](/docs/django/integrations/guardian).
...
See [Model Properties guide](/docs/django/guide/model-properties) for details.

### How do I work with Django's choices fields?

Use [django-choices-field](/docs/django/integrations/choices-field):
...
See [Relay guide](/docs/django/guide/relay).
...
See [Unit Testing guide](/docs/django/guide/unit-testing).
...
See [Subscriptions guide](/docs/django/guide/subscriptions) for setup details.
