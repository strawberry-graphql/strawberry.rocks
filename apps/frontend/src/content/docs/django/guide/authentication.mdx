...
This allows authentication to work seamlessly with [subscriptions](/docs/django/guide/subscriptions).
...
You can catch these in your frontend or use [error handling extensions](/docs/django/guide/error-handling).
