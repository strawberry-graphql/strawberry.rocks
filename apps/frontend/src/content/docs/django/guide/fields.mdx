...
---
> [!TIP]
> It is highly recommended to enable the [Query Optimizer Extension](optimizer)
...
> it is recommended using the [django-choices-field](../integrations/choices-field) integration
> enum handling.
