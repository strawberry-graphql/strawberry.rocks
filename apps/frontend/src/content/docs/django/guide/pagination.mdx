...
[strawberry django settings](./settings) to increase or decrease that number,
...
while also adding [ordering](./ordering) to it. This can be achieved with:
...
you can leverage the [relay integration](./relay) provided by strawberry
