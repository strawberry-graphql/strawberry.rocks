...
[strawberry django settings](/docs/django/guide/settings) to increase or decrease that number,
...
while also adding [ordering](/docs/django/guide/ordering) to it. This can be achieved with:
