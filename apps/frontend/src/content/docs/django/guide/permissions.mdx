...
See the [django-guardian integration](/docs/django/integrations/guardian) for setup instructions.
...
- [django-guardian Integration](/docs/django/integrations/guardian) - Object-level permissions
- [Authentication](/docs/django/guide/authentication) - User authentication
- [Error Handling](/docs/django/guide/error-handling) - Handling permission errors