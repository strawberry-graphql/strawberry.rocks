...
See the [Filtering Guide](/docs/django/guide/filters) for comprehensive filter documentation.
...
See the [Ordering Guide](/docs/django/guide/ordering) for detailed ordering documentation.
...
> [!NOTE]
> Returning `list[Fruit]` means the queryset is evaluated immediately. For paginated queries with metadata (total count, page info), use `OffsetPaginated[Fruit]` with `pagination=True` instead. See the [Pagination guide](/docs/django/guide/pagination) for details.
>
...
See the [Pagination Guide](/docs/django/guide/pagination) for more pagination strategies.
...
See the [Custom Resolvers Guide](/docs/django/guide/resolvers) for advanced resolver patterns.
...
See the [Query Optimizer Guide](/docs/django/guide/optimizer) for optimization details.
...
- [Filtering](/docs/django/guide/filters) - Comprehensive filtering guide
- [Ordering](/docs/django/guide/ordering) - Sort and order results
- [Pagination](/docs/django/guide/pagination) - Paginate large result sets
- [Query Optimizer](/docs/django/guide/optimizer) - Prevent N+1 queries
- [Custom Resolvers](/docs/django/guide/resolvers) - Advanced resolver patterns
- [Relay](/docs/django/guide/relay) - Relay-style connections and nodes
