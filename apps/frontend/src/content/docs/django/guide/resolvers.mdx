...
When using custom resolvers together with the [Query Optimizer Extension](/docs/django/guide/optimizer)
you might need to give it a "hint" on how to optimize that field

Take a look at the [optimization hints](/docs/django/guide/optimizer#optimization-hints)
...
(e.g. `Pagination`, `Filter`), exception for [relay connections](/docs/django/guide/relay). You can
