...
[subscriptions](/docs/django/guide/subscriptions) and WebSocket support with Django.
...
1. **Check ASGI\_APPLICATION** is correctly set in settings
...
- [Subscriptions Guide](/docs/django/guide/subscriptions) - Creating subscriptions
