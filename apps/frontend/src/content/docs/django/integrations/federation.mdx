...
The [Query Optimizer](/docs/django/guide/optimizer) works with federated schemas. Add the
extension as usual:
...
authentication headers. See [Authentication](/docs/django/guide/authentication) for
