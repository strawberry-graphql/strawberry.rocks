...
are similar to [entities](/docs/federation/entities), but usually can't contribute new
...
rules as [entities](/docs/federation/entities) apply here. Here's a basic example:
