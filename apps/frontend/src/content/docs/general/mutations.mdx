...
Let's improve our books project from the [Getting started tutorial](/docs)
...
[`InputMutationExtension`](/docs/extensions/input-mutation), a
[field extension](/docs/guides/field-extensions) that automatically creates an
