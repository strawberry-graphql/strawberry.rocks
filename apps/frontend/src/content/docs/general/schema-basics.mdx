...
called “schema-first” and the other is called “code-first”. Strawberry *only*
...
[*resolver*](/docs/types/resolvers) that provides some data to a field through a
function.
...
the [resolvers section](/docs/types/resolvers).
...
[custom `StrawberryConfig` on the schema](/docs/types/schema-configurations)
