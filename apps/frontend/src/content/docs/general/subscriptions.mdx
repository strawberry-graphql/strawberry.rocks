...
At some point it may be necessary to implement a pub-sub pattern.
When the client chooses to unsubscribe to an endpoint, it can be caught in a
try ... except block.
...
Note: Check the [channels integraton](/docs/integrations/channels) page for more
