...
If you were using Apollo Federation v1, you must migrate to [Federation v2]((/docs/guides/federation)). Apollo Federation v1 is no longer supported by Strawberry.

Check out the [breaking changes documentation](/docs/breaking-changes/0.285.0) for detailed migration instructions.
