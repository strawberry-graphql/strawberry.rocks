...
[Getting Started tutorial](/docs/index#step-5-create-our-schema-and-run-it) to
run our first test:
...
We can also write a test for our [`addBook` Mutation](/docs/general/mutations)
example:
...
And finally, a test for our [`count` Subscription](/docs/general/subscriptions):
