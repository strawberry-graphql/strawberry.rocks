...
Let's improve our books project from the [Getting started tutorial](../
...
[`InputMutationExtension`](../extensions/input-mutation), a
[field extension](../guides/field-extensions) that automatically creates an
