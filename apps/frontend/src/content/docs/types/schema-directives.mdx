...
> For example our [Apollo Federation integration](/docs/guides/federation) is
...
[Object types definitions](/docs/types/object-types) and accepts one parameter called
