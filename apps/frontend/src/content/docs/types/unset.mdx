...
[`Maybe`](/docs/types/maybe) instead, which provides better type safety and clearer
...
We recommend migrating to [`Maybe`](/docs/types/maybe) for new code. See the
[migration guide](/docs/types/maybe#migrating-from-unset) for details.
...
- [Maybe](/docs/types/maybe) - The recommended alternative for input field handling
- [Input Types](/docs/types/input-types) - Defining input types
