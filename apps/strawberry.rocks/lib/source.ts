...
export function getPageImage(page: InferPageType<typeof strawberrySource> | InferPageType<typeof djangoSource>) {
...
export async function getLLMText(page: InferPageType<typeof strawberrySource> | InferPageType<typeof djangoSource>) {
