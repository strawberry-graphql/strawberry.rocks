    ...
    <header className="px-8 py-4 md:flex mx-auto w-full max-w-7xl justify-between md:items-center">
      ...
      <div className="flex order-none md:order-first flex-1 items-center">
        <nav className="flex w-full md:w-auto justify-center md:justify-items-start space-x-10">
          ...
          <NavLink target="_blank" href="/discord">
            <svg viewBox="0 0 800 272.1" className="h-8 align-middle">
      ...
      <div className="hidden md:flex justify-end items-center flex-1">
        ...
        {version && (
          <Link
            className="no-underline bg-red-300 p-2 text-white hover:bg-red-500"
            target="_blank"
            href={
              versionHref ??
