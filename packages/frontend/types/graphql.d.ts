...
export type PullRequestQueryVariables = Exact<{
  owner: Scalars["String"];
  repo: Scalars["String"];
  pull_number: Scalars["Int"];
}>;

export type PullRequestQuery = {
  repository?: Maybe<{
    pullRequest?: Maybe<
      Pick<PullRequest, "state" | "number" | "headRefName" | "url"> & {
        headRepositoryOwner?: Maybe<
          Pick<Organization, "login"> | Pick<User, "login">
        >;
        repository: Pick<Repository, "name">;
        labels?: Maybe<{ nodes?: Maybe<Array<Maybe<Pick<Label, "name">>>> }>;
      }
    >;
  }>;
};
...
export type FileQuery = {
  repository?: Maybe<{
    object?: Maybe<({ __typename: "Blob" } & Pick<Blob, "text">) | {}>;
  }>;
};
...
export type LatestReleaseQuery = {
  repository?: Maybe<{ latestRelease?: Maybe<Pick<Release, "tagName">> }>;
};
...
export type ExtensionsPagesQuery = {
  repository?: Maybe<{
    object?: Maybe<
      | ({ __typename: "Tree" } & {
...
export type CodeOfConductQuery = {
  repository?: Maybe<{
    codeOfConduct?: Maybe<Pick<CodeOfConduct, "body">>;
    latestRelease?: Maybe<Pick<Release, "tagName">>;
  }>;
};
...
export type DocPageQuery = {
  repository?: Maybe<{
    object?: Maybe<({ __typename: "Blob" } & Pick<Blob, "text">) | {}>;
    tableOfContents?: Maybe<({ __typename: "Blob" } & Pick<Blob, "text">) | {}>;
  }>;
};
