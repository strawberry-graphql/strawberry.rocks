...
export type PullRequestQuery = { repository?: Maybe<{ pullRequest?: Maybe<(
      Pick<PullRequest, 'state' | 'number' | 'headRefName' | 'url'>
      & { headRepositoryOwner?: Maybe<Pick<Organization, 'login'> | Pick<User, 'login'>>, repository: Pick<Repository, 'name'>, labels?: Maybe<{ nodes?: Maybe<Array<Maybe<Pick<Label, 'name'>>>> }> }
    )> }> };
